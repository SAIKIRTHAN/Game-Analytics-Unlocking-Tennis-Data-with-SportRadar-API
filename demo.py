...
# Database Connection
my_db = myconn.connect(host="localhost", username="root", password="root", database="Tennis")
...
def fetch_data(endpoint):
    url = "https://api.sportradar.com/tennis/trial/v3/en/competitions.json?api_key=g2uKrq7C4iuO6T9ItS7MOwNMGTT2cQp8Vadh7gzX"
